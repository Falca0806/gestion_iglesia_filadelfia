...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-02-2024 a las 17:35:26
...
--
ALTER TABLE `cargos`
  MODIFY `cargos_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `personal`
  MODIFY `personal_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
