...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-02-2024 a las 21:53:57
...
CREATE TABLE `actividades` (
  ...
  `actividades_hora_ini` time NOT NULL,
  `actividades_hora_fin` time NOT NULL,
...
INSERT INTO `actividades` (`actividades_id`, `actividades_nombre`, `actividades_detalle`, `actividades_fecha`, `actividades_hora_ini`, `actividades_hora_fin`, `ministerios_id`) VALUES
(3, 'Actividad seis', 'sdsfdsfdsfds', '2024-05-01', '12:00:00', '12:30:00', 1),
(4, 'Actividad nueve', 'sdsdfdfdfsdf', '2024-05-01', '08:30:00', '10:00:00', 1),
(5, 'Actividad diez', 'sdasdsdasd', '2024-05-01', '12:30:00', '13:00:00', 1);
...
(1, 'Administrador', 'Encargado de toda la gestión de la Iglesia.'),
(2, 'Asistente', 'Encargado de brindar apoyo y asistencia a las personas en las diversas areas de la Iglesia.'),
(3, 'Responsable', 'Encargado del ministerio asignado.'),
(4, 'Limpieza', 'Limpiar todas las areas');
...
INSERT INTO `ministerios` (`ministerios_id`, `ministerios_nombre`, `ministerios_funcion`, `personal_dni`) VALUES
(1, 'Adoranza y Alabanza', 'Adorar y alabar', '28455759');
...
(1, '30131490', 'Christian', 'Monasterios', '2001-06-08', '04146809866', 'La Faria', 'costerochristian@gmail.com', 'Masculino', 'Soltero', 1),
(2, '29509136', 'Sten', 'Isamberth', '2000-05-03', '04127548955', 'Av. Delicias', 'stenisamberth@gmail.com', 'Masculino', 'Casado', 2),
(3, '28455759', 'Emely', 'Vilchez', '2001-01-01', '04124598755', 'Av. Delicias', 'emely@gmail.com', 'Femenino', 'Casado', 3),
(4, '10088461', 'Prueba', 'Prueba', '1969-05-23', '04164587455', 'Los pinos', 'prueba@gmail.com', 'Masculino', 'Casado', 2),
(5, '100884615', 'Pruebauno', 'Prueba', '2009-01-28', '04164587455', 'Los pinos', 'prueba@gmail.com1', 'Masculino', 'Soltero', 1),
(6, '9791254', 'pruebatres', 'gggg', '2000-02-02', '04146794588', 'victoria', 'pruebaa@gmail.com', 'Femenino', 'Soltero', 1),
(7, '4521254', 'Juan', 'Jaramillo', '2001-01-01', '04126459877', 'Los molinos', 'juan@gmail.com', 'Masculino', 'Soltero', 4),
(8, '19455787', 'fgdg', 'dfgdfg', '1990-01-01', '25456554546', 'dfgdgdgdg', 'fgdgf@gmail.com', 'Masculino', 'Soltero', 2);
...
(1, 'Admin', '$2y$10$ywsbqPWsFf3lnmEt6dDuW.ZGJowxLdrwouYIMg5iWSpaJbdIki9oK', '30131490', 1),
(2, 'Asistente1', '$2y$10$6yCpH1ViLy7BeCkPhu4mxOhO5kYkL3FmV831QeuMgAGtaFbQKfHXe', '29509136', 2);
...
--
ALTER TABLE `actividades`
  MODIFY `actividades_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `cargos`
--
ALTER TABLE `cargos`
  MODIFY `cargos_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `ministerios`
  MODIFY `ministerios_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `personal`
  MODIFY `personal_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
