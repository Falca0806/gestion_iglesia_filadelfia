...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-02-2024 a las 17:33:39
...
--
ALTER TABLE `cargos`
  MODIFY `cargos_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `personal`
  MODIFY `personal_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `usuarios`
  MODIFY `usuarios_id` int(10) NOT NULL AUTO_INCREMENT;
